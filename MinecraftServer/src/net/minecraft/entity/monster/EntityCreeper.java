...
public class EntityCreeper extends EntityMob
{
    ...
    private void explode()
    {
        if (!this.world.isRemote)
        {
            ...
            this.dead = true;
            if(modified) this.world.createExplosion(this, this.posX, this.posY, this.posZ, (float)this.explosionRadius * f * 10, flag);
            else this.world.createExplosion(this, this.posX, this.posY, this.posZ, (float)this.explosionRadius * f, flag);
            this.setDead();
            this.func_190741_do();
        }
    }
