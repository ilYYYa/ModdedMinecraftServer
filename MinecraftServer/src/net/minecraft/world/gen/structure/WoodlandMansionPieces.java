...
public class WoodlandMansionPieces
{
    ...
    static class Grid
    {
        ...
        {
            return (this.field_191120_d[p_191114_4_].func_191145_a(p_191114_2_, p_191114_3_) & 65535) == p_191114_5_;
        }
        ...
        private void func_191115_b()
        {
            ...
            for (int i = 0; i < this.field_191119_c.field_191150_c; ++i)
            {
                for (int j = 0; j < this.field_191119_c.field_191149_b; ++j)
                {
                    ...
                    {
                        list.add(new Tuple(Integer.valueOf(j), Integer.valueOf(i)));
                    }
                }
            }
    ...
    static class Placer
    {
                    ...
                    for (int l1 = 0; l1 < woodlandmansionpieces$simplegrid3.field_191149_b; ++l1)
                    {
                        ...
                        if (woodlandmansionpieces$simplegrid3.func_191145_a(l1, k1) == 2 || flag1)
                        {
                            ...
                            if (WoodlandMansionPieces.Grid.func_191109_a(woodlandmansionpieces$simplegrid3, l1, k1 + 1) && !p_191125_4_.func_191114_a(woodlandmansionpieces$simplegrid3, l1, k1 + 1, l2, k2))
                            {
                                ...
                                p_191125_3_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, enumfacing1 == EnumFacing.SOUTH ? s3 : s2, blockpos4, p_191125_2_.add(Rotation.CLOCKWISE_90)));
                            }
        ...
        private void func_191123_a(List<WoodlandMansionPieces.MansionTemplate> p_191123_1_, BlockPos p_191123_2_, Rotation p_191123_3_, WoodlandMansionPieces.SimpleGrid p_191123_4_, @Nullable WoodlandMansionPieces.SimpleGrid p_191123_5_)
        {
            for (int i = 0; i < p_191123_4_.field_191150_c; ++i)
            {
                ...
                {
                    BlockPos lvt_8_1_ = p_191123_2_.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 8 + (i - this.field_191137_d) * 8);
                    lvt_8_1_ = lvt_8_1_.offset(p_191123_3_.rotate(EnumFacing.EAST), (j - this.field_191136_c) * 8);
                    ...
                    {
                        p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "roof", lvt_8_1_.up(3), p_191123_3_));

                        if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j + 1, i))
                        {
                            BlockPos blockpos1 = lvt_8_1_.offset(p_191123_3_.rotate(EnumFacing.EAST), 6);
                            p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "roof_front", blockpos1, p_191123_3_));
                        }

                        if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j - 1, i))
                        {
                            BlockPos blockpos5 = lvt_8_1_.offset(p_191123_3_.rotate(EnumFacing.EAST), 0);
                            blockpos5 = blockpos5.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 7);
                            p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "roof_front", blockpos5, p_191123_3_.add(Rotation.CLOCKWISE_180)));
                        }

                        if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j, i - 1))
                        {
                            BlockPos blockpos6 = lvt_8_1_.offset(p_191123_3_.rotate(EnumFacing.WEST), 1);
                            p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "roof_front", blockpos6, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
                        }

                        if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j, i + 1))
                        {
                            BlockPos blockpos7 = lvt_8_1_.offset(p_191123_3_.rotate(EnumFacing.EAST), 6);
                            blockpos7 = blockpos7.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 6);
                            p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "roof_front", blockpos7, p_191123_3_.add(Rotation.CLOCKWISE_90)));
                        }
                    }
                }
            }
            ...
            if (p_191123_5_ != null)
            {
                for (int k = 0; k < p_191123_4_.field_191150_c; ++k)
                {
                    ...
                    {
                        BlockPos lvt_8_3_ = p_191123_2_.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 8 + (k - this.field_191137_d) * 8);
                        lvt_8_3_ = lvt_8_3_.offset(p_191123_3_.rotate(EnumFacing.EAST), (i1 - this.field_191136_c) * 8);
                        ...
                        if (WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k) && flag1)
                        {
                            ...
                            {
                                BlockPos blockpos8 = lvt_8_3_.offset(p_191123_3_.rotate(EnumFacing.EAST), 7);
                                p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "small_wall", blockpos8, p_191123_3_));
                            }

                            if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1 - 1, k))
                            {
                                BlockPos blockpos9 = lvt_8_3_.offset(p_191123_3_.rotate(EnumFacing.WEST), 1);
                                blockpos9 = blockpos9.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 6);
                                p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "small_wall", blockpos9, p_191123_3_.add(Rotation.CLOCKWISE_180)));
                            }

                            if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k - 1))
                            {
                                BlockPos blockpos10 = lvt_8_3_.offset(p_191123_3_.rotate(EnumFacing.WEST), 0);
                                blockpos10 = blockpos10.offset(p_191123_3_.rotate(EnumFacing.NORTH), 1);
                                p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "small_wall", blockpos10, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
                            }

                            if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k + 1))
                            {
                                BlockPos blockpos11 = lvt_8_3_.offset(p_191123_3_.rotate(EnumFacing.EAST), 6);
                                blockpos11 = blockpos11.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 7);
                                p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "small_wall", blockpos11, p_191123_3_.add(Rotation.CLOCKWISE_90)));
                            }
                            ...
                            if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1 + 1, k))
                            {
                                if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k - 1))
                                {
                                    BlockPos blockpos12 = lvt_8_3_.offset(p_191123_3_.rotate(EnumFacing.EAST), 7);
                                ...
                                if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k + 1))
                                {
                                    BlockPos blockpos13 = lvt_8_3_.offset(p_191123_3_.rotate(EnumFacing.EAST), 8);
                                    blockpos13 = blockpos13.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 7);
                                    p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "small_wall_corner", blockpos13, p_191123_3_.add(Rotation.CLOCKWISE_90)));
                                }
                            }
                            ...
                            if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1 - 1, k))
                            {
                                if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k - 1))
                                {
                                    BlockPos blockpos14 = lvt_8_3_.offset(p_191123_3_.rotate(EnumFacing.WEST), 2);
                                    blockpos14 = blockpos14.offset(p_191123_3_.rotate(EnumFacing.NORTH), 1);
                                    p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "small_wall_corner", blockpos14, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
                                }

                                if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k + 1))
                                {
                                    BlockPos blockpos15 = lvt_8_3_.offset(p_191123_3_.rotate(EnumFacing.WEST), 1);
                ...
                for (int j1 = 0; j1 < p_191123_4_.field_191149_b; ++j1)
                {
                    ...
                    if (WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1, l) && !flag2)
                    {
                        if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1 + 1, l))
                        {
                            ...
                            if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1, l - 1))
                            {
                                p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "roof_corner", blockpos16, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
                            }
                            else if (WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1 + 1, l - 1))
                            {
                                ...
                                p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "roof_inner_corner", blockpos19, p_191123_3_.add(Rotation.CLOCKWISE_90)));
                            }
                        }
                        ...
                        if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1 - 1, l))
                        {
                            ...
                            if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1, l + 1))
                            {
                                ...
                                p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "roof_corner", blockpos20, p_191123_3_.add(Rotation.CLOCKWISE_90)));
                            }
                            else if (WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1 - 1, l + 1))
                            {
                                ...
                                p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "roof_inner_corner", blockpos21, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
                            }

                            if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1, l - 1))
                            {
                                p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "roof_corner", blockpos17, p_191123_3_.add(Rotation.CLOCKWISE_180)));
                            }
                            else if (WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1 - 1, l - 1))
                            {
        ...
        private void func_191132_a(List<WoodlandMansionPieces.MansionTemplate> p_191132_1_, BlockPos p_191132_2_, Rotation p_191132_3_, EnumFacing p_191132_4_, EnumFacing p_191132_5_, WoodlandMansionPieces.RoomCollection p_191132_6_, boolean p_191132_7_)
        {
            ...
            else if (p_191132_5_ == EnumFacing.WEST && p_191132_4_ == EnumFacing.NORTH)
            {
                ...
                p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, p_191132_6_.func_191100_a(this.field_191135_b, p_191132_7_), blockpos11, p_191132_3_.add(Rotation.CLOCKWISE_180)));
            }
            ...
            else if (p_191132_5_ == EnumFacing.SOUTH && p_191132_4_ == EnumFacing.EAST)
            {
                ...
                p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, p_191132_6_.func_191100_a(this.field_191135_b, p_191132_7_), blockpos9, p_191132_3_.add(Rotation.CLOCKWISE_90), Mirror.LEFT_RIGHT));
            }
            else if (p_191132_5_ == EnumFacing.SOUTH && p_191132_4_ == EnumFacing.WEST)
            {
                ...
                p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, p_191132_6_.func_191100_a(this.field_191135_b, p_191132_7_), blockpos8, p_191132_3_.add(Rotation.CLOCKWISE_90)));
            }
            else if (p_191132_5_ == EnumFacing.NORTH && p_191132_4_ == EnumFacing.WEST)
            {
                ...
                p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, p_191132_6_.func_191100_a(this.field_191135_b, p_191132_7_), blockpos7, p_191132_3_.add(Rotation.CLOCKWISE_90), Mirror.FRONT_BACK));
            }
            else if (p_191132_5_ == EnumFacing.NORTH && p_191132_4_ == EnumFacing.EAST)
            {
                ...
                p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, p_191132_6_.func_191100_a(this.field_191135_b, p_191132_7_), blockpos6, p_191132_3_.add(Rotation.COUNTERCLOCKWISE_90)));
            }
            ...
            else if (p_191132_5_ == EnumFacing.NORTH && p_191132_4_ == EnumFacing.SOUTH)
            {
                ...
                p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, p_191132_6_.func_191098_b(this.field_191135_b, p_191132_7_), blockpos4, p_191132_3_.add(Rotation.CLOCKWISE_180)));
            }
            else if (p_191132_5_ == EnumFacing.WEST && p_191132_4_ == EnumFacing.EAST)
            {
                ...
                p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, p_191132_6_.func_191098_b(this.field_191135_b, p_191132_7_), blockpos3, p_191132_3_.add(Rotation.CLOCKWISE_90)));
            }
            else if (p_191132_5_ == EnumFacing.EAST && p_191132_4_ == EnumFacing.WEST)
            {
                ...
                p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, p_191132_6_.func_191098_b(this.field_191135_b, p_191132_7_), blockpos2, p_191132_3_.add(Rotation.COUNTERCLOCKWISE_90)));
            }
            else if (p_191132_5_ == EnumFacing.UP && p_191132_4_ == EnumFacing.EAST)
            {
                ...
                p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, p_191132_6_.func_191102_c(this.field_191135_b), blockpos1, p_191132_3_.add(Rotation.CLOCKWISE_90)));
            }
    ...
    abstract static class RoomCollection
    {
        ...
        public abstract String func_191104_a(Random p_191104_1_);

        public abstract String func_191099_b(Random p_191099_1_);

        public abstract String func_191100_a(Random p_191100_1_, boolean p_191100_2_);

        public abstract String func_191098_b(Random p_191098_1_, boolean p_191098_2_);

        public abstract String func_191102_c(Random p_191102_1_);

        public abstract String func_191101_d(Random p_191101_1_);

        public abstract String func_191103_e(Random p_191103_1_);
    }
