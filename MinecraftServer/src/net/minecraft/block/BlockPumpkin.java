...
public class BlockPumpkin extends BlockHorizontal
{
    ...
    {
    	int i = 1;
    	while(pos.getY() - i > 1 && world.getBlockState(pos.down(i)) == Blocks.SNOW.getDefaultState()) i++;
    	
		if(entity instanceof EntityLiving && i > 1)
		{
    		EntityLiving LE = (EntityLiving) entity;
    		LE.addPotionEffect(new PotionEffect(Potion.getPotionById(25), 25 * i, 1 * i/4));
		}
		else if(entity instanceof EntityPlayer && i > 1)
		{
			EntityPlayer pl = (EntityPlayer) entity;
    		pl.addPotionEffect(new PotionEffect(Potion.getPotionById(25), 25 * i, 1 * i/4));
		}
    }
